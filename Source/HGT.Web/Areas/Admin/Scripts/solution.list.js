...
function gridConfigInit(dataSource) {
    ...
    jQuery("#grid").kendoGrid({
        ...
        "columns": [
        {
            ...
            "template": "<a href=\"/admin/solution/Input/#= Id#\"> #= Name#</a>",
        ...
        },
        {
            ...
            "template": "<a href=\"/admin/solution/galleryDetail?solutionId=#= Id#&redirectUrl=/admin/solution\"><span>#= TotalGallery # </span><br/>Thêm mới</a>",
...
function edit(id) {
    var siteUrl = "/admin/solution/Input/";
    $(location).attr('href', siteUrl + id);
}
